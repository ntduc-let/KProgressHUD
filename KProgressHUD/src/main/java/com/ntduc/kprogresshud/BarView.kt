...
internal class BarView : View, Determinate {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val widthDimension = Helper.dpToPixel(100f, context)
        val heightDimension = Helper.dpToPixel(20f, context)
    ...
    override fun setProgress(progress: Int) {
        mProgress = progress
        mInBound!![mBoundGap, mBoundGap, (width - mBoundGap) * mProgress / mMax] =
            height - mBoundGap
        invalidate()
    }
}